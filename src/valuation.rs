...
impl RationalAgent {
    ...
    fn value_generated_by_higher_order_good(
        ...
        // MOST IMP TODO: DON'T FORGET TO HANDLE MATERIALS DIFFERENTLY!
        ...
        // (number of uses) of the higher-order good.

        // Note: the following results in a recursive call to this method.
        (higher_order_goods_unit.remaining_lifetime as f32)
            * self.marginal_unit_value_of_capital_good(lower_order_good)
    }
